...
class BookTableMap extends TableMap
{
     ...
     */
    const COL_BOOKID = 'book.bookID';

    /**
     * the column name for the bookName field
     */
    const COL_BOOKNAME = 'book.bookName';

    /**
     * the column name for the yearOfRelease field
     */
    const COL_YEAROFRELEASE = 'book.yearOfRelease';

    /**
     * the column name for the bookDescription field
     */
    const COL_BOOKDESCRIPTION = 'book.bookDescription';
    ...
    /**
     * the column name for the bookImage field
     */
    const COL_BOOKIMAGE = 'book.bookImage';

    /**
     * the column name for the author_authID1 field
     */
    const COL_AUTHOR_AUTHID1 = 'book.author_authID1';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Bookid', 'Bookname', 'Yearofrelease', 'Bookdescription', 'Isbn', 'Bookimage', 'AuthorAuthid1', ),
        self::TYPE_CAMELNAME     => array('bookid', 'bookname', 'yearofrelease', 'bookdescription', 'isbn', 'bookimage', 'authorAuthid1', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_BOOKID, BookTableMap::COL_BOOKNAME, BookTableMap::COL_YEAROFRELEASE, BookTableMap::COL_BOOKDESCRIPTION, BookTableMap::COL_ISBN, BookTableMap::COL_BOOKIMAGE, BookTableMap::COL_AUTHOR_AUTHID1, ),
        self::TYPE_FIELDNAME     => array('bookID', 'bookName', 'yearOfRelease', 'bookDescription', 'ISBN', 'bookImage', 'author_authID1', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Bookid' => 0, 'Bookname' => 1, 'Yearofrelease' => 2, 'Bookdescription' => 3, 'Isbn' => 4, 'Bookimage' => 5, 'AuthorAuthid1' => 6, ),
        self::TYPE_CAMELNAME     => array('bookid' => 0, 'bookname' => 1, 'yearofrelease' => 2, 'bookdescription' => 3, 'isbn' => 4, 'bookimage' => 5, 'authorAuthid1' => 6, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_BOOKID => 0, BookTableMap::COL_BOOKNAME => 1, BookTableMap::COL_YEAROFRELEASE => 2, BookTableMap::COL_BOOKDESCRIPTION => 3, BookTableMap::COL_ISBN => 4, BookTableMap::COL_BOOKIMAGE => 5, BookTableMap::COL_AUTHOR_AUTHID1 => 6, ),
        self::TYPE_FIELDNAME     => array('bookID' => 0, 'bookName' => 1, 'yearOfRelease' => 2, 'bookDescription' => 3, 'ISBN' => 4, 'bookImage' => 5, 'author_authID1' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('bookID', 'Bookid', 'INTEGER', true, null, null);
        $this->addColumn('bookName', 'Bookname', 'VARCHAR', true, 255, null);
        $this->addColumn('yearOfRelease', 'Yearofrelease', 'DATE', true, null, null);
        $this->addColumn('bookDescription', 'Bookdescription', 'VARCHAR', true, 255, null);
        $this->addColumn('ISBN', 'Isbn', 'VARCHAR', true, 255, null);
        $this->addColumn('bookImage', 'Bookimage', 'VARCHAR', false, 255, null);
        $this->addForeignKey('author_authID1', 'AuthorAuthid1', 'INTEGER', 'author', 'authID', true, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':bookID',
        ...
        $this->addRelation('Booktagged', '\\Booktagged', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':book_bookID',
    1 => ':bookID',
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(BookTableMap::COL_BOOKID);
            $criteria->addSelectColumn(BookTableMap::COL_BOOKNAME);
            $criteria->addSelectColumn(BookTableMap::COL_YEAROFRELEASE);
            $criteria->addSelectColumn(BookTableMap::COL_BOOKDESCRIPTION);
            $criteria->addSelectColumn(BookTableMap::COL_ISBN);
            $criteria->addSelectColumn(BookTableMap::COL_BOOKIMAGE);
            $criteria->addSelectColumn(BookTableMap::COL_AUTHOR_AUTHID1);
        } else {
            $criteria->addSelectColumn($alias . '.bookID');
            $criteria->addSelectColumn($alias . '.bookName');
            $criteria->addSelectColumn($alias . '.yearOfRelease');
            $criteria->addSelectColumn($alias . '.bookDescription');
            $criteria->addSelectColumn($alias . '.ISBN');
            $criteria->addSelectColumn($alias . '.bookImage');
            $criteria->addSelectColumn($alias . '.author_authID1');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(BookTableMap::COL_BOOKID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(BookTableMap::COL_BOOKID) && $criteria->keyContainsValue(BookTableMap::COL_BOOKID) ) {
