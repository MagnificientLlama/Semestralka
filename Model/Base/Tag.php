...
abstract class Tag implements ActiveRecordInterface
{
    ...
    /**
     * The value for the tagdescription field.
     *
     * @var        string
     */
    ...
    /**
     * Get the [tagdescription] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [tagname] column.
     *
    ...
    public function setTagname($v)
    {
        ...
        if ($this->tagname !== $v) {
            $this->tagname = $v;
            $this->modifiedColumns[TagTableMap::COL_TAGNAME] = true;
        }
    ...
    /**
     * Set the value of [tagdescription] column.
     *
     * @param string $v new value
     * @return $this|\Tag The current object (for fluent API support)
     */
    public function setTagdescription($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->tagdescription !== $v) {
            $this->tagdescription = $v;
            $this->modifiedColumns[TagTableMap::COL_TAGDESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TagTableMap::translateFieldName('Tagname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tagname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TagTableMap::translateFieldName('Tagdescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tagdescription = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_TAGNAME)) {
            $modifiedColumns[':p' . $index++]  = 'tagName';
        }
        if ($this->isColumnModified(TagTableMap::COL_TAGDESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'tagDescription';
        }
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'tagName':
                        $stmt->bindValue($identifier, $this->tagname, PDO::PARAM_STR);
                        break;
                    case 'tagDescription':
                        $stmt->bindValue($identifier, $this->tagdescription, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getTagname(),
            $keys[1] => $this->getTagdescription(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setTagname($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setTagdescription($arr[$keys[1]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_TAGNAME)) {
            $criteria->add(TagTableMap::COL_TAGNAME, $this->tagname);
        }
        if ($this->isColumnModified(TagTableMap::COL_TAGDESCRIPTION)) {
            $criteria->add(TagTableMap::COL_TAGDESCRIPTION, $this->tagdescription);
        }
    ...
    /**
     * Generic method to set the primary key (tagname column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTagdescription($this->getTagdescription());
     ...
     * @return ObjectCollection|ChildBooktagged[] List of ChildBooktagged objects
     */
    public function getBooktaggedsJoinBook(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBooktaggedQuery::create(null, $criteria);
