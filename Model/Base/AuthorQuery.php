...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(AuthorTableMap::COL_AUTHID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(AuthorTableMap::COL_AUTHID, $keys, Criteria::IN);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByAuthid(1234); // WHERE authID = 1234
     * $query->filterByAuthid(array(12, 34)); // WHERE authID IN (12, 34)
     * $query->filterByAuthid(array('min' => 12)); // WHERE authID > 12
     * </code>
     *
     * @param     mixed $authid The value to use as filter.
    ...
    public function filterByAuthid($authid = null, $comparison = null)
    {
        if (is_array($authid)) {
            $useMinMax = false;
            if (isset($authid['min'])) {
                $this->addUsingAlias(AuthorTableMap::COL_AUTHID, $authid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($authid['max'])) {
                $this->addUsingAlias(AuthorTableMap::COL_AUTHID, $authid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AuthorTableMap::COL_AUTHID, $authid, $comparison);
    }
     ...
     * $query->filterByAuthname('%fooValue%', Criteria::LIKE); // WHERE authName LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByAuthname($authname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AuthorTableMap::COL_AUTHNAME, $authname, $comparison);
    }
    ...
    public function filterByDateofbirth($dateofbirth = null, $comparison = null)
    {
        if (is_array($dateofbirth)) {
            ...
            if (isset($dateofbirth['min'])) {
                $this->addUsingAlias(AuthorTableMap::COL_DATEOFBIRTH, $dateofbirth['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateofbirth['max'])) {
                $this->addUsingAlias(AuthorTableMap::COL_DATEOFBIRTH, $dateofbirth['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByBook($book, $comparison = null)
    {
        if ($book instanceof \Book) {
            return $this
                ->addUsingAlias(AuthorTableMap::COL_AUTHID, $book->getAuthorAuthid1(), $comparison);
    ...
    {
        if ($author) {
            $this->addUsingAlias(AuthorTableMap::COL_AUTHID, $author->getAuthid(), Criteria::NOT_EQUAL);
        }
